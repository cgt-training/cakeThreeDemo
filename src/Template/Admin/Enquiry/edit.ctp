<?php
     ...
     $this->Html->addCrumb(__('Edit Enquiry'));
?>
<div class="row-fluid">
            ...
            <?= $this->Flash->render() ?>
                <div class="navbar navbar-inner block-header">
                    <div class="muted pull-left"><?= __('Edit Enquiry') ?></div>
                        ...
                        <?= $this->Html->link('<i class="icon-list"></i>', ['action' => 'index', $enquiry->id],['escape'=>false,'title'=>__('index'),'class'=>'AjaxLink']) ?>&nbsp;&nbsp;
                        ...
                        ['confirm' => __('Are you sure?'),'escape'=>false,'title'=>'Delete'])
                        ?>
                        </div>
                </div>
