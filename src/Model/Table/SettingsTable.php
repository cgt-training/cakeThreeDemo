...
class SettingsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('layout_name', 'create')
            ->notEmpty('layout_name');

        $validator
            ->requirePresence('language', 'create')
            ->notEmpty('language');
        $validator
            ->add('layout_name', 'inList', [
                'rule' => ['inList', ['layoutFirst', 'layoutSecond']],
                'message' => 'Please enter a valid layout_name'
            ]);
        $validator
            ->add('language', 'inList', [
                'rule' => ['inList', ['en_US', 'en_HN']],
